...
\arguments{
  ...
  \item{withClass}{Logical. Whether to include linkage result in the output.}
  \item{withWeight}{Logical. Whether to include weights in the output.}
  \item{sort}{Logical. Whether to sort descending by weights.}
